package org.fractalstudio.engine.model.daetofe;
...
public class DaeToFeConverter {
	 ...
	 * @param inputFile
	 */
	public static org.fractalstudio.render.geometry.Geometry convertModel(
			String inputFile) {
		...
		try {
			 ...
			 */
			org.fractalstudio.render.geometry.Geometry geometry = new org.fractalstudio.render.geometry.Geometry();

			for (FEMesh feMesh : meshes) {

				org.fractalstudio.render.geometry.mesh.Mesh mesh = new org.fractalstudio.render.geometry.mesh.Mesh();
